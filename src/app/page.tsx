  ...
  return (
    <div suppressHydrationWarning className={`min-h-screen ${hookTheme === 'light' ? 'cover-gradient-white' : 'cover-gradient-black'}`}>
          ...
          <div className="absolute top-0 left-0 z-[-5] h-[95vh] w-screen">
            ...
            <div className="px-6">
                <div>
                  ...
                  >
                      <Image src={`${process.env.NEXT_PUBLIC_S3}/netflix_series.webp`} width={140} height={140} className="select-none max-sm:mx-auto w-[120px] sm:w-[140px]" alt="netflix_series" loading="lazy"/>
                  </motion.div>
                </div>
                <div className="mt-5">
                  <Image src={`${process.env.NEXT_PUBLIC_S3}/logo_test.webp`} width={450} height={450} className="select-none w-[400px] max-sm:mx-auto sm:w-[450px] max-h-[150px]" alt="logo_test" priority/>
                </div>
        ...
        <div className="mt-5 lg:mt-8 px-6">
            ...
            <div className="mt-5">
            <Image src={`${process.env.NEXT_PUBLIC_S3}/movie_image/m0.webp`} width={380} height={380} className="select-none w-[380px] max-h-[213.93px] rounded" alt="logo_m0" loading="lazy"/>
            </div>
        </div>
    </div>
  );
